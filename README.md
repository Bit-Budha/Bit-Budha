...
My goal is to live in the Linux (CLI) command line interface, programming, and hacking, while never having to slow down and feel gooey in the GUI (graphical user interface) or chase a mouse.
